...
export const FRAGEN = [
  ...
  [2, "tiere", "🐆", "Welches ist das schnellste Tier an Land?", ["Gepard", "Löwe", "Pferd", "Hase"], "Ein Gepard ist so schnell wie ein Auto in der Stadt – aber nur für kurze Zeit."],
  ...
  [1, "natur", "☀️", "Was scheint am Tag hell vom Himmel und wärmt uns?", ["die Sonne", "der Mond", "ein Stern-Schnuppe", "eine Wolke"], "Die Sonne ist ein riesiger Stern. Ihr Licht braucht etwa 8 Minuten bis zu uns."],
  ...
  [2, "welt", "🏙️", "Welche Großstadt liegt direkt neben Fürth?", ["Nürnberg", "Hamburg", "Köln", "Bremen"], "Die Straßenbahn fährt von Nürnberg bis nach Fürth."],
  ...
  [2, "welt", "🦅", "Welches Tier ist das Wappentier von Deutschland?", ["Adler", "Löwe", "Bär", "Hirsch"], "Den Bundesadler siehst du auf jeder Euromünze aus Deutschland."],
  ...
  [1, "kurios", "🐝", "Was machen Bienen aus Blütennektar?", ["Honig", "Marmelade", "Milch", "Zucker"], "Für ein Glas Honig fliegen Bienen zusammen eine Strecke, die mehrmals um die Erde reicht."],
  ...
  [1, "kurios", "🐦", "Kann ein Strauß fliegen?", ["Nein, aber schnell laufen", "Ja, sehr weit", "Nur nachts", "Nur rückwärts"], "Ein Strauß rennt so schnell wie ein Auto in der Stadt."],
  ...
  [3, "wissen", "🎹", "Welcher berühmte Komponist konnte später nicht mehr hören?", ["Ludwig van Beethoven", "Wolfgang Amadeus Mozart", "Johann Sebastian Bach", "Michael Jackson"], "Beethoven komponierte weiter, obwohl er taub war – er spürte die Töne."],
